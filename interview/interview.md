...
​	存在各大团队重复遭轮子，跨业务合作困难等问题，针对这种情况，我们将这些大型产品开发中遇到的问题进行抽象、形成一个统一的解决方案，通过在跨业务团队以及特定大型业务线中试点

what？

​	**阿里玄难之前说过：中台是一个基础的理念和架构，我们要把所有的基础服务用中台的思路建设，进行联通，共同支持端上的业务** 
...
![image-20191230174043536](/Users/wzb/Documents/Android_Dev_Note/interview/assets/image-20191230174043536.png)
...
使用:
	...
	1. 初始化一个module，生命周期，初始化
 	2. hook方法，1种是hook方法调用，一种是替换方法

例子：

	1. 微信数据库hook，数据库没有修改(兼容低版本)，群(公告、权限、群名、人员)、联系人、朋友圈
 	2. hook微信打日志的类，然后打印日志
 	3. 群消息，hook数据库增删改查，取出消息，通过长链接回传给服务器
 	4. 添加好友，方法，activity的方法
